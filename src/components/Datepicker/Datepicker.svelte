...
<style global>
  ...
  /* .flatpickr-months .flatpickr-prev-month, .flatpickr-months .flatpickr-next-mont){
    color: var(--nu-text-color)
  }
  .flatpickr-months .flatpickr-prev-month, .flatpickr-months .flatpickr-next-month):hove {
    color: var(--l-grey-1)
  } */
  ...
  .flatpickr-calendar.multiMonth .flatpickr-days .dayContainer:nth-child(n + 2) .flatpickr-day.inRange:nth-child(7n + 1) {
    -webkit-box-shadow: -2px 0 0 rgba(1, 1, 1, 0.8), 5px 0 0 rgba(1, 1, 1, 0.8);
    box-shadow: -2px 0 0 rgba(1, 1, 1, 0.8), 5px 0 0 rgba(1, 1, 1, 0.8);
  }
  ...
  .flatpickr-calendar.arrowBottom:before {
    border-top-color: var(--nu-border-color);
  }
  .flatpickr-calendar.arrowBottom:after {
    border-top-color: var(--nu-border-color);
  }
  ...
  ::-webkit-input-placeholder {
    /* Chrome */
    color: rgb(var(--nu-text-color-rgb), 0.6);
  }
  ...
  .flatpickr-days {
    ...
    width: 307.875px;
    border-left: 1px solid var(--nu-border-color);
  ...
  .dayContainer + .dayContainer {
    -webkit-box-shadow: -1px 0 0 var(--nu-border-color);
    box-shadow: -1px 0 0 var(--nu-border-color);
  }
  .flatpickr-day {
    background: none;
  ...
  .flatpickr-time .numInputWrapper span.arrowUp:after {
    border-bottom-color: var(--nu-text-color);
  }
  .flatpickr-time .numInputWrapper span.arrowDown:after {
    border-top-color: var(--nu-text-color);
  }
